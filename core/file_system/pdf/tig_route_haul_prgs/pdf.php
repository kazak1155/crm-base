...
<table id='veh_table'>
	...
	<tr>
		<td colspan='3'>
			...
			Простои на месте погрузки 100 EURO за каждые сутки.
			...
			За  правильное  оформление  и  наличие документов  отвечает  водитель. Если  не хватает  каких-либо документов, об этом  сразу  надо информировать заказчика посредством элетронной почты.
			О  простоях  в  местах  погрузки – выгрузки нужно информировать заказчика посредством электронной почты. Всё это должно быть зафиксировано в ЦМР (CMR) и подтверждено печатью.
