			...
			<div id="params-content">
				...
				<div>
					<p>
						...
						<sup><small>3</small></sup> (включительно),<br />
				...
				<div>
					<p>
						При весе груза более <input name="overweight_volume" value="<?php echo $this->req_data['self_calc_overweight']['value'] ?>"/> - идивидуальный просчет
					</p>
				</div>
			</div>
		</form>
