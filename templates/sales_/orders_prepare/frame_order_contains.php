...
$(function() {
	...
	new jqGrid$({
		...
		table:'Форма_Заказ_Состав',
		tableQuery:'Заказы_Состав',
		id:'Код',
		formpos:false,
		hideBottomNav:true,
		useLs:false,
		...
		footer:[
			{col:'Стоимость_фабрика',calc:'sum'},
			{col:'Объем',calc:'sum'},
			{col:'Кол_во',calc:'sum'},
			{col:'Вес',calc:'sum'}
		],
		...
		cn:[
			"Код","Заказы_Код","Вид груза","Валюта","Описание","Артикул","Себ.Фабрики","Объем","Кол-во","Вес","Ц.фабрики","Ц.логистика"
		],
		cm:[
			{
			...
			{
				name: "Цена_фабрика",index:"Цена_фабрика",width:100,editable:false
			},

			{
				name: "Цена_логистика",index:"Цена_логистика",width:100,editable:false
			}
		],
		options:{
			shrinkToFit:true,
