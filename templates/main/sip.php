...
<script src="/vendor/sipml5/release/SIPml-api.js" type="text/javascript"> </script>
<!-- Javascript code -->
<script type="text/javascript">
	...
	function sipRegister() {
		...
		//	return;
		//	}
		var o_impu = tsip_uri.prototype.Parse("sip:107@sip.tlc-online.ru");
		//var o_impu = "sip:107@sip.tlc-online.ru";
		...
		oSipStack = new SIPml.Stack({
				...
				impu: "sip:107@sip.tlc-online.ru",
				...
				websocket_proxy_url: ("wss://sip.tlc-online.ru:8445/ws"),
	...
	function uiDisableCallOptions() {
		if (window.localStorage) {
			window.localStorage.setItem('org.doubango.expert.disable_call//btn_options', 'true');
			ui//btnCallSetText('Call');
...
<audio id="ringtone" loop src="vendor/sipml5/sounds/ringtone.wav"> </audio>
<audio id="ringbacktone" loop src="vendor/sipml5/sounds/ringbacktone.wav"> </audio>
<audio id="dtmfTone" src="vendor/sipml5/sounds/dtmf.wav"> </audio>
