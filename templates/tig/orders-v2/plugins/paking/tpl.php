	...
	<form class="м" id="orderpaking">
		<fieldset>
			...
			<div class='float_label_wrapper' style="width:calc(33% - 15px);">
				<input type="text" name="Номер_Инвойса" class="float_input" value="<?php echo $this->req_data['Номер_Инвойса'] ?>"/>
				<label class="float_label">Номер инвойса</label>
			</div>
			<div class='float_label_wrapper' style="width:calc(33% - 15px);">
				<input type="text" name="Сумма_Инвойса" class="float_input" value="<?php echo $this->req_data['Сумма_Инвойса'] ?>"/>
				<label class="float_label">Сумма инвойса</label>
			</div>
			<div class='float_label_wrapper' style="width:calc(33% - 15px);">
				<input type="text" name="MRN" class="float_input" value="<?php echo $this->req_data['MRN'] ?>"/>
				<label class="float_label">MRN</label>
			</div>
