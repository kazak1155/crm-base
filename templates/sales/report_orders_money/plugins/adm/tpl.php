...
<div id="form_wrapper">
	...
	<form class="gridToForm" id="orderadmin">
		<fieldset>
			...
			<div class='float_label_wrapper'>
				<input type="text" name="Сумма_согласование" class="float_input" min-value='0.00' required value="<?php echo $this->req_data['Сумма_согласование'] ?>"/>
				<label class="float_label">Сумма согласованная</label>
			</div>
			<div class='float_label_wrapper'>
				<input type="text" name="Сумма_транспорт" class="float_input" min-value='0.00' required value="<?php echo $this->req_data['Сумма_транспорт'] ?>"/>
