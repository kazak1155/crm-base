...
$(function() {
	new jqGrid$({
		...
		cn:[
			"Код","Курьер","Регион","Провинция","Фабрика","V-min","V-max","Цена","Min-Цена"
		],
		cm:[
			{
			...
			{
				name: "Фабрики_Код",index:"Фабрики_Код",width:200,sortable:false,formatter:'select',stype:'select',
				formatoptions:{
