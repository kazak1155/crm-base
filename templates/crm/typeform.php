<?php
$selPlaceholoder = "Выберите или введите тип...";
$selectID = "Тип_Обращения";
$selectClass = 1;
?>
...
<div id="chosesel<?=$selectClass;?>" class="chosesel<?=$selectClass;?>" style="position:absolute;height:200px;max-height:200px;width:400px;overflow: auto;background-color: #ffffff;z-index:30000010;display:none;padding:15px;">
...
<script>
	$( document ).ready(function() {
		$('#chosesel<?=$selectClass;?>').width('400px');
	});
</script>
