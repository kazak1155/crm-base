...
$selPlaceholoder = "Выберите или введите тему...";
$selectID = "Тема";
$selectClass = 2;
?>
...
<script> //alert('XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX');
	...
	function getSelectData2(){ //alert('ssssssssssssss');
		var datArray;
			...
			for (dtKey in datArray) {
				if(typeof(datArray[dtKey][0]) != "function" &&  typeof(datArray[dtKey][0]) != "undefined") {
					...
					var toString = "<div style='"+style2+"'>"+datArray[dtKey][0]
						+ "<div style='float:right;"+style2+"'><a href='javascript:void(0);' onClick='javascript:edpict2(\""+datArray[dtKey][0]+"\",\""+datArray[dtKey][1]+"\");'>" + "<img src='/css/images/pensel03.png'></a>"
						+ "&#160;"
						+ "<div style='float:right;"+style2+"'><a href='javascript:void(0);' onClick='javascript:rmpict2(\""+datArray[dtKey][0]+"\",\""+datArray[dtKey][1]+"\");'>" + "<img src='/css/images/crus01.png'></a>"
						+ "</div></div>";
					//alert(toString);
...
<div id="chosesel<?=$selectClass;?>" class="chosesel<?=$selectClass;?>" style="position:absolute;height:165px;max-height:165px;width:400px;overflow: auto;background-color: #ffffff;z-index:30000010;display:none;padding:15px;">
	...
	<a href='javascript:void(0);' onClick='javascript:saveselect2();' style="text-decoration: none;color:#000000;"><img src="/css/images/arrow01.png"></a> &#160;
	<a href='javascript:void(0);' onClick='javascript:closeselect2();' style="text-decoration: none;color:#000000;"><img src="/css/images/crus01.png"></a>
	</span>
